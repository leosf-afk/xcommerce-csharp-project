...
-- --------------------------------------------------
-- Date Created: 07/31/2023 11:45:34
-- Generated from EDMX file: C:\Users\54381\Desktop\Xcom\Xcom.AccesoDatos\ModeloXcom.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_FormaPagoEfectivoCliente]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[FormasPagos_FormaPagoEfectivo] DROP CONSTRAINT [FK_FormaPagoEfectivoCliente];
GO
...
GO
IF OBJECT_ID(N'[dbo].[MotivosReservas]', 'U') IS NOT NULL
    DROP TABLE [dbo].[MotivosReservas];
GO
...
-- Creating table 'MotivosReservas'
CREATE TABLE [dbo].[MotivosReservas] (
    [Id] bigint IDENTITY(1,1) NOT NULL,
    [Descripcion] nvarchar(250)  NOT NULL
);
GO
...
-- Creating primary key on [Id] in table 'MotivosReservas'
ALTER TABLE [dbo].[MotivosReservas]
ADD CONSTRAINT [PK_MotivosReservas]
    PRIMARY KEY CLUSTERED ([Id] ASC);
GO
...
ADD CONSTRAINT [FK_MotivoReservaReserva]
    ...
    REFERENCES [dbo].[MotivosReservas]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
GO
...
-- Creating foreign key on [ClienteId] in table 'FormasPagos_FormaPagoEfectivo'
ALTER TABLE [dbo].[FormasPagos_FormaPagoEfectivo]
ADD CONSTRAINT [FK_FormaPagoEfectivoCliente]
    FOREIGN KEY ([ClienteId])
    REFERENCES [dbo].[Personas_Cliente]
        ([Id])
    ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- Creating non-clustered index for FOREIGN KEY 'FK_FormaPagoEfectivoCliente'
CREATE INDEX [IX_FK_FormaPagoEfectivoCliente]
ON [dbo].[FormasPagos_FormaPagoEfectivo]
    ([ClienteId]);
GO
